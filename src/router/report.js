const { orderReport, orderCount, highestOrder, lowestOrder, orderPacking, orderShipping, gst, averageOrderValue, codAmount, digitalAmount, maxOrderFoodItems, readsingleuserData } = require("../controllers/report");
...
module.exports = function (app) {
    ...
    app.post("/orderreport", logUserActivity("View"), [], orderReport)
        .post("/ordercount", logUserActivity("View"), [], orderCount)
        .post("/maxordervalue", logUserActivity("View"), [], highestOrder)
        .post("/minordervalue", logUserActivity("View"), [], lowestOrder)
        .post("/orderpacking", logUserActivity("View"), [], orderPacking)
        .post("/ordershipping", logUserActivity("View"), [], orderShipping)
        .post("/gst", logUserActivity("View"), [], gst)
        .post("/averageOrderValue", logUserActivity("View"), [], averageOrderValue)
        .post("/codAmount", [], logUserActivity("View"), codAmount)
        .post("/digitalAmount", [], logUserActivity("View"), digitalAmount)
        .post("/maxOrderProducts", logUserActivity("View"), [], maxOrderFoodItems)
        .post("/findsingleuser", logUserActivity("View"), [], readsingleuserData);
