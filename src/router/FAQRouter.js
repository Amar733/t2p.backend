const { createFAQ, viewFAQ, removeFAQ, updateFAQ, updateStatus, viewFAQFrontend } = require("../controllers/FAQController")
...
module.exports = function (app) {
    ...
    app
        .post("/admin/create-faq", logUserActivity("Create"), createFAQ)
        .post("/admin/fetch-faq", logUserActivity("View"), viewFAQ)
        .post("/admin/delete-faq", logUserActivity("Delete"), removeFAQ)
        .post("/admin/update-faq", logUserActivity("Update"), updateFAQ)
        .post("/admin/update-status", logUserActivity("Update"), updateStatus)
        .get("/api/fetch-faq", logUserActivity("View"), viewFAQFrontend)
}
