const { create, view, deleteTestimonial, updateTestimonial, FinancialLog_delete, FinancialLog_Edit } = require("../controllers/TestimonialController")
...
module.exports = function (app) {
    ...
    app
        .post("/admin/create-testimonial", logUserActivity("Create"), authenticateToken, create)
        .post("/admin/fetch-testimonial", logUserActivity("View"), view)
        .post("/admin/delete-testimonial", logUserActivity("Delete"), authenticateToken, deleteTestimonial)
        .post("/admin/update-testimonial", logUserActivity("Update"), authenticateToken, updateTestimonial)
        .post("/admin/financial-log-delete", logUserActivity("Delete"), authenticateToken, FinancialLog_delete)
        .post("/admin/financial-log-edit", logUserActivity("Update"), authenticateToken, FinancialLog_Edit)
}
